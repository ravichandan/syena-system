...
public interface WatchRepository extends CrudRepository<Watch, Serializable> {
	...
	@Query("select tm.email as targetMemberEmail,w.watchName as watchName,w.targetAccepted as targetAccepted from Watch w left join w.originMember om left join w.targetMember tm where om.email = :email")
